...
from value_iteration.cartpole_run_experiment import run_experiment
from value_iteration.value_function import (
    QuadraticNetwork,
    TrigonometricQuadraticNetwork,
)
...
def main():
    ...
    parser.add_argument(
        ...
        default=1,
        required=False,
        help="Specifies whether to load an existing model.",
    )
    ...
    hyper["xi_x_alpha"] = 0.025 if hyper["robust"] else 1.0e-6
    hyper["xi_u_alpha"] = 0.100 if hyper["robust"] else 1.0e-6
    hyper["xi_o_alpha"] = 0.025 if hyper["robust"] else 1.0e-6
    hyper["xi_m_alpha"] = 0.150 if hyper["robust"] else 1.0e-6
